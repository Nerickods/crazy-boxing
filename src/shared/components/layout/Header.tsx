    ...
    <>
      <header
        className={`fixed top-0 w-full z-50 transform-gpu transition-[background-color,backdrop-filter,-webkit-backdrop-filter,border-color,opacity,box-shadow] duration-500 ${
          isScrolled
            ? 'glass-panel border-b border-white/5 h-16 shadow-[0_8px_32px_rgba(0,0,0,0.3)]'
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-full grid grid-cols-[1fr_auto_1fr] items-center">
          ...
          <div className="flex justify-center items-center">
            ...
            >
              <div className="relative w-10 h-10 flex items-center justify-center overflow-hidden rounded-lg bg-white/5 border border-white/10 group-hover:border-blue-600/50 transition-colors duration-500 shadow-[0_0_0_0_rgba(37,99,235,0)] group-hover:shadow-[0_0_20px_-5px_rgba(37,99,235,0.3)]">
                <img
                  src="/assets/logo.png"
              ...
              <div className="flex flex-col">
                <span className="text-white font-black tracking-[0.2em] text-sm leading-none group-hover:text-blue-500 transition-colors duration-500">
                  CRAZY
                </span>
          ...
          <div className="flex items-center justify-end">
            ...
            >
               <div className="size-9 md:size-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-blue-600/50 transition-all duration-300 group-hover:scale-110 active:scale-95 overflow-hidden">
